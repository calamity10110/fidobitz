...
@patch("os.cpu_count")
def test_healthy_tick(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
...
@patch("houndmind_ai.safety.health_monitor._read_mem_used_pct")
@patch("os.cpu_count")
def test_degraded_load(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
...
@patch("houndmind_ai.safety.health_monitor._read_mem_used_pct")
@patch("os.cpu_count")
def test_degraded_temp(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
...
@patch("houndmind_ai.safety.health_monitor._read_mem_used_pct")
@patch("os.cpu_count")
def test_degraded_memory(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
...
@patch("houndmind_ai.safety.health_monitor._read_mem_used_pct")
@patch("os.cpu_count")
def test_missing_metrics(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
...
@patch("houndmind_ai.safety.health_monitor._read_mem_used_pct")
@patch("os.cpu_count")
def test_throttling_actions(mock_cpu_count, mock_mem, mock_gpu, mock_cpu_temp, mock_load, module):
    mock_cpu_count.return_value = 4
    mock_load.return_value = 2.0
    mock_cpu_temp.return_value = 80.0 # >= 70.0
    mock_gpu.return_value = 55.0
